...
results1 = pd.read_csv('./results_criteria1.csv')['Price']
results1 = np.asarray([price_cols.index(x) for x in results1])

results2 = pd.read_csv('./results_rev_criteria1.csv')['Price']
...
final_df.to_csv('./results_merged_criteria1.csv', index = False)