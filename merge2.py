...
results1 = pd.read_csv('./results_criteria2.csv')['Price']
results1 = np.asarray([price_cols.index(x) for x in results1])

results2 = pd.read_csv('./results_rev_criteria2.csv')['Price']
...
final_df.to_csv('./results_merged_criteria2.csv', index = False)